...
const cacheName = 'Team2AFinalProject-2021-04-21 00:08:37.197076'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Team2AFinalProject'.length) === 'Team2AFinalProject') {
